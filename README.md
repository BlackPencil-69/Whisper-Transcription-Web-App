...
| Модель | Швидкість | Точність | Пам'ять (RAM) | Рекомендації |
|--------|-----------|----------|---------------|--------------|
...
| `medium` | ⚡ | 🟢 дуже висока | ~5 GB | Для професійної транскрипції |
| `large` | 🐢 | 🟢 найкраща | ~10 GB | Максимальна якість (потрібна потужна система) |
...
- `example1_with_subs.mp4` - Приклад української мови
- `example2_with_subs.mp4` - Приклад англійської мови
